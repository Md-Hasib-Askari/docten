...
import { durations } from "@/app/dashboard/prescription/[appointmentId]/constants";
    ...
    return (
        <form className="space-y-4">
            <Modal
                ...
                onOpenChange={setAddMedicineModal}
            >
                <ModalContent>
                    {(onClose) => (
                        <>
            ...
            <div className="flex flex-row gap-2">
                <Autocomplete
                    ...
                    onSelectionChange={(key) =>
                        formik.setFieldValue("frequency", key)
                    }
                >
                    {(item) => (
                ...
                <Autocomplete
                    ...
                    onSelectionChange={(key) =>
                        formik.setFieldValue("duration", key)
                    }
                >
                    {(item) => (
                        <AutocompleteItem key={item.label}>
            ...
            />
            <Autocomplete label="Note" variant="bordered">
                <AutocompleteItem key="1">Note 1</AutocompleteItem>
            </Autocomplete>
