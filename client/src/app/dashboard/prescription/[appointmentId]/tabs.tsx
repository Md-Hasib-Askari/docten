            ...
            >
              ...
              */}
                ...
                <Tab key="complaints" title="Complaints">
                    <Card>
                        <CardBody>
                            <Section title="Chief Complaints" type="complaint">
                                <form className="space-y-4">
                                    <div className="flex flex-row gap-5">
                                        <Input className="w-4/5" label="Name" />
                                        <Input
                ...
                <Tab key="history" title="History">
                    <Card>
                        <CardBody>
                            <Section title="History" type="history">
                                <form className="space-y-4">
                                    <div className="flex flex-row gap-5">
                                        <Input className="w-4/5" label="Name" />
                                        <Input
                ...
                <Tab key="investigation" title="Investigation">
                    <Card>
                        <CardBody>
                            <Section title="Investigation" type="investigation">
                                <form className="space-y-4">
                                    <div className="flex flex-row gap-5">
                                        <Input className="w-4/5" label="Name" />
                                        <Input
                ...
                <Tab key="diagnosis" title="Diagnosis">
                    <Card>
                        <CardBody>
                            <Section title="Diagnosis" type="investigation">
                                <form className="space-y-4">
                                    <div className="flex flex-row gap-5">
                                        <Input className="w-4/5" label="Name" />
                                        <Input
